...
//	}
	...
	public String toString() {
		...
		System.out.println();
		System.out.println("Candidate vertices: ");
		System.out.println(candidate_vertices);
		
		System.out.println();
		System.out.println("Excluded vertices: ");
		System.out.println(excluded_vertices);
		...
		try {
			...
			out.write("Vertices");
			out.write(",");
			out.write("Candidate_Vertices");
			out.write(",");
			out.write("Extended_Vertices");
			out.write(",");
			out.write("Edges");
			out.write(",");
			out.write("Weights");
			...
			if(vertices.size() > candidate_vertices.size()) {
				size = vertices.size(); 
			}
			else {
				size = candidate_vertices.size();
			}
			...
			for (int i = 0; i < size; i++)
			{
				if(i >= vertices.size()) {
					...
					String value = String.valueOf(vertices.get(i));
					out.write(value);
				}
				out.write(",");
			    /*
			    if(i >= candidate_vertices.size()) {
			    	out.write("");
				}
				else {
					String value1 = String.valueOf(candidate_vertices.get(i));
					out.write(value1);
				}
			    out.write(",");
			    
			    Iterator it = excluded_vertices.iterator(); // why capital "M"?
			    if(it.hasNext()) {
			    	out.write((int) it.next());
			    } else {
			    	out.write("");
			    }
			    out.write(",");
			    
			    Iterator ed = edges.iterator(); // why capital "M"?
			    if(it.hasNext()) {
			    	out.write((int) ed.next());
			    } else {
			    	out.write("");
			    }
			    out.write(",");
			    ...
			    */
			    ...
			    /*
			    Iterator<Vertex> it = excluded_vertices.iterator();
			     while(it.hasNext()){
			...
			for(int i = 0; i < 20; i++) {
				...
				if(String.valueOf(vertices.get(i)) != ""){
					myWriter.write(String.valueOf(vertices.get(i)));
				}
				
				myWriter.write(",");
				myWriter.write(String.valueOf(candidate_vertices.get(i)));
				//myWriter.write(",");
				//myWriter.write(String.valueOf(excluded_vertices.get(i)));
				//myWriter.write(",");
				//myWriter.write(String.valueOf(edges.get(i)));
				//myWriter.write(",");
				//myWriter.write(String.valueOf(weight.get(i)));
				myWriter.write("\n");
			}
			*/
			...
			System.out.println("Succesffully wrote to file.");
		} catch (IOException e) {
	...
	// to here	
			...
			/*
			List<Integer> targetList = new ArrayList<>(edges);
			
			Iterator hashSetIterator = edges.iterator();
			while(hashSetIterator.hasNext()){
				
			    myWriter.write(hashSetIterator.next().toString());
			}
			
			List<List<String>> rows = Arrays.asList(
								
								for(int i = 0; i < vertices.size(); i++) {
									Arrays.asList(String.valueOf(vertices.get(i)), ',')
								}
							);
			*/
